...
---------------------------------------------------
-- Step1 - Create database with name bankmanagementsystem in mysql
create database bankmanagementsystem;

-- Step 2 - Select the database you just created
use bankmanagementsystem;

-- Step 3 - Create our first Table in the selected database with name signup
...
-- Step 4 - Create the second table to store more information of user
...
-- Step 5 - Create the third table to store the account information of user
...
-- Step 6 - Create the Login table to store login information
create table login(formno varchar(20), cardnumber varchar(25), pin varchar(10));

-- Step 7 - Now create bank table to store transactions related information 
