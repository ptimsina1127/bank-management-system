...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        JLabel name = new JLabel("Race");
        name.setFont(new Font("Raleway",Font.BOLD,20));
        name.setBounds(100, 140, 100, 30);
        add(name);
        
        String valReligion[]={"NONE","Hispanic","Indian America","Asian","Other"};
        ...
        String valCategory []= {"NONE","Christian","Muslim","Hindu","Other"};
        ...
        String incomeCategory []= {"NONE","<20000","<50000","<100000","upto 500000"};
        ...
        String educationValues []= {"NONE","Some High School","Bachelors","Masters","Doctorate"};
        ...
        JLabel address = new JLabel("PAN/SSN No");
        ...
        ButtonGroup syesno = new ButtonGroup();
        syesno.add(syes);
        syesno.add(sno);
        ...
        ButtonGroup eyesno = new ButtonGroup();
        eyesno.add(eyes);
        eyesno.add(eno);
